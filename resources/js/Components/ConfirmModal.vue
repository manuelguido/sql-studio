...
<template>
	<Teleport to="body">
		<Transition name="modal">
			...
			>
				<!-- Backdrop -->
				<div class="absolute inset-0 bg-black/55 backdrop-blur-[2px]" @click="close"></div>
				...
				>
					...
					<div
						class="flex items-center justify-end gap-2 border-t hairline bg-[color:var(--color-surface)]/30 px-5 py-3"
					>
						<button
							type="button"
